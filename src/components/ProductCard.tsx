...
const ProductCard : FC<IproductCard> = ({img, alt, title, description, price, onClick}) => {
  console.log(onClick)
  return (
    <div className='flex flex-col p-2 rounded-lg gap-3 justify-start border '>
        ...
        <div className='flex flex-row justify-between gap-2 text-white mb-3'>
            <Button className={"w-full h-8 rounded-md bg-indigo-500"}  onClick={(e) => {onClick()}}> Edit </Button>
